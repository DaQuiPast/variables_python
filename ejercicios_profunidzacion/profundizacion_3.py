...
print(nombre_completo.upper()) #pasa el nombre a mayusculas

print(nombre_completo.lower()) #pasa el nombre a minusculas

print(nombre_completo.capitalize()) #Capitaliza la primer letra del nombre
