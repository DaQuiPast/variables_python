...
resta = numero_1 - numero_2  #aqui se realiza la declaracion de la variable resta
print("el resultado de restar", numero_1, "y", numero_2, "es", resta) #aqui mostramos el resultado en la consola
